...
/**
 * \file    core/triggers/interface_99_modQtycheck_QtycheckTriggers.class.php
 * \ingroup qtycheck
 ...
 *      - interface_99_modQtycheck_MyTrigger.class.php
...
/**
 *  Class of triggers for Qtycheck module
 */
class InterfaceQtycheckTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Qtycheck triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'qtycheck@qtycheck';
	}
	...
	public function lineorderSupplierCreate(string $action, $object, User $user)
	{
		$this->qtycheck($object, $user);
	...
	public function linepropalInsert(string $action, $object, User $user)
	{
		$this->qtycheck($object, $user);
	...
	public function linesupplierProposalInsert(string $action, $object, User $user)
	{
		$this->qtycheck($object, $user);
	...
	public function linebillInsert(string $action, $object, User $user)
	{
		$this->qtycheck($object, $user);
	...
	public function linebillSupplierCreate(string $action, $object, User $user)
	{
		$this->qtycheck($object, $user);
